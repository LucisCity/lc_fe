...
function SvgAnim404() {
  ...
  return (
    <svg id="the_svg" width="95%" viewBox="0 0 636 324" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="OBJECTS">
        <g id="Group">
          <path
            id="Vector"
            ...
            fill="#2F1829"
          />
          {/*<text className={s.text1} x="270" y="280" fill="white" fontFamily="monospace">Page Not Found</text>*/}
          {/*<text className={s.text2} x="255" y="300" fill="white" fontFamily="monospace" fontSize="11">Click anywhere to go home</text>*/}
          <path
            id="Vector_2"
