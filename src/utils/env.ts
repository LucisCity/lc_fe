...
export const appVersionCommitId = "LUCIS_VERSION_COMMIT_ID"; // This will be override in compile phase by webpack
export const appOrigin = isClient ? window.location.hostname : "";

console.log('{}:', {appEnv, isClient, isDevMode, isClientDevMode, isStandaloneMode, appOrigin, appVersionCommitId});
